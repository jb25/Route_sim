"""
Genera launch_emulators.ps1 con contenido limpio (sin problemas de encoding).
Uso:  python write_launch_script.py
"""
...
out = Path("launch_emulators.ps1")
out.write_text(PS1, encoding="utf-8")
print(f"OK - {out} reescrito ({len(PS1)} bytes)")
